...
## Original information about the data (citation)
...
## General information about variable editing

* The datasets were combined to a single dataset (consisting of IDs, activities and body measures).

* Of the body measures only variables of interest (mean and standard deviation of each measurement) were keeped, everything else dropped.

* The activity levels were labeld according to information found in the original files.

* Finally for each subject (30) and activity (6) a mean of the measured body signals was calculated - resulting in 30x6 = 180 rows - and saved in a new tidy dataset, which is described below.

## Basic descriptive variable measures
